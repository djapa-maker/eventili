 ...
 * @author ahmed
 */
public class ServiceCategoryVideo {

    public static ServiceCategoryVideo instance = null;
    ...
    public static ServiceCategoryVideo getInstance() {
        if (instance == null) {
            instance = new ServiceCategoryVideo();
        }
        return instance;
    }

    public ServiceCategoryVideo() {
...
//                        v.setDescription(id_categ);
    ...
    public boolean modifierVideo(Video video) {
        ...
        String url = Statics.BASE_URL + "/admin/video/updateVideoJSON/" + video.getId() + "title=" + video.getTitle() + "&description=" + video.getDescription() + "&imagePath=" + video.getImage_path() + "&videoPath=" + video.getVideo_path() + "&duration=" + video.getDuration() + "&idCateg=" + video.getCateg().getId(); // aa sorry n3adi getId lyheya mech ta3 user ta3 reclamation
